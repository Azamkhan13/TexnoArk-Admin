    ...
    <div>
      {
        ...
        <button
        onClick={handleOpen}
        className="py-2 px-6 text-white font-semibold bg-[#2e942ee9] duration-200 rounded-lg"
      >
        To Open
      </button> : 
      <Button
        ...
        <Box sx={style}>
          ...
          >
            <Form className=" max-w-[600px]  w-full flex flex-col gap-[12px]">
              ...
              <Button
                sx={{ fontSize: "16px", fontWeight: "600" ,backgroundColor: "#to add", "&:hover" :{background: "#2e942ee9"} }}
                variant="contained"
                type="submit"
