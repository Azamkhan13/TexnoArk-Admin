          ...
          <div className="px-3 pt-4">
            ...
            >
                ...
                <Form className="w-full flex flex-col gap-[8px]">
                  <h2 className="text-center text-[#000] text-[22px] pb-4 font-semibold">Edite product detels</h2>
                  ...
                  <Button
                    sx={{ fontSize: "16px", fontWeight: "600", padding: "14px", backgroundColor: "#2e942ee9", "&:hover": { background: "#2e942ee9" } }}
                    variant="contained"
                    type="submit"
                    className="w-[100%]"
                  >
