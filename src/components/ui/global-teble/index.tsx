            ...
            >
              ...
              <TableBody>
                {skelatonLoader ? (
                              ...
                              {heder.value == "action" ? (
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <Button
                                    sx={{ color: "#767676" }}
                                    onClick={() => {
                                      navigate(`/home/category/${body?.id}`);
                                    }}
                                    className=" text-gray-500"
                                  >
                                    <VisibilityIcon />
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <Button
                                    sx={{ color: "#767676" }}
                                    onClick={() => {
                                      navigate(`/home/products/${body?.id}`);
                                    }}
                                    className=" text-gray-500"
                                  >
                                    <VisibilityIcon />
                                ...
                                <div className="flex items-center gap-2">
                                  <div className=" text-gray-500">
                                    <ModalDelete id={body?.id} title="stock" />
                                  </div>
                                  <ModalStock
                                    title="put"
                                    id={body?.id}
                  ...
                  <TableRow>
                    <TableCell colSpan={heders?.length}>
                      No information!!!
                    </TableCell>
                  </TableRow>
                )}
