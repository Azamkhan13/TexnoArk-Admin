  ...
  return (
    <>
      ...
      <div className="auth-parent">
        <div
          className={`login-auth ${isSignUp ? "active" : ""}`}
          id="login-auth"
        >
            ...
            >
              {({ errors, touched }: FormikProps<any>) => (
                <Form className="w-full flex flex-col gap-[8px]">
                  <h2 className=" text-center text-[#000] text-[33px] font-semibold">
                    Creat account
                  </h2>
                  <Field
                    as={TextField}
            ...
            >
              {({ errors, touched }: FormikProps<any>) => (
                <Form className="w-full flex flex-col gap-[15px]">
                  <h2 className=" text-center text-[#000] text-[44px] font-semibold">
                    Sign In
                  </h2>
                  <Field
                    as={TextField}
                  ...
                  <p
                    ...
                    className="text-[20px] text-[#000] forgrt-pasword cursor-pointer"
                  >
                    Forgot password?
                  </p>
